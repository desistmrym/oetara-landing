                ...
                <div key={data[0].id} className="font-['europa-grotesk-sh-med']">
                    {data[0].acf.case_gallery.length > 1 ? 
                        <div className="flex">
                            ...
                            <img src={data[0].acf.case_gallery[1].sizes.large} alt="" className="w-[100%] h-[96vh] object-contain" />
                    ...
                    <div className="py-3 flex justify-between gap-3">
                        ...
                        <div className="w-[50%]">
                            <div className="text-[3em] text-[#d43735]" dangerouslySetInnerHTML={{__html: data[0].title.rendered}} ></div>
                            <div className="py-2 text-[1.5em]" dangerouslySetInnerHTML={{__html: data[0].acf.case_description}}></div>
                        </div>
                    </div>
                </div>
            :
